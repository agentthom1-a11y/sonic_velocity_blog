      ...
      <header className="fixed top-0 left-0 right-0 z-50 h-14 bg-neutral-950 border-b border-neutral-900 flex items-center justify-between px-6">
        ...
        <nav className="flex items-center gap-1">
          {[
            ...
            <a key={link.href} href={link.href} className="px-3 py-1.5 text-[9px] uppercase tracking-[0.2em] text-neutral-500 hover:text-white hover:bg-neutral-900 transition-all rounded-sm">
              {link.label}
            </a>
          ))}
          <LogoutButton />
